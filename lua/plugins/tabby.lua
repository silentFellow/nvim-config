...
return {
  ...
  config = function()
    ...
    -- Define a custom keymap for switching to the next tab
    vim.api.nvim_set_keymap('n', "<tab>l", ':tabn<CR>', { noremap = true, silent = true, desc = "tab next" })
    vim.api.nvim_set_keymap('n', "<tab>h", ':tabp<CR>', { noremap = true, silent = true, desc = "tab previous" })
    vim.api.nvim_set_keymap('n', "<tab>n", ':$tabnew<CR>', { noremap = true, silent = true, desc = "new tab" })
    vim.api.nvim_set_keymap('n', "<tab>c", ':tabclose<CR>', { noremap = true, silent = true, desc = "new tab" })
  end,
}
